    ...
    <main className="min-h-screen bg-[#F7F5EF] px-5 py-8 text-[#17312F] sm:px-8">
      ...
      <section className="relative mx-auto grid min-h-[calc(100vh-4rem)] max-w-5xl overflow-hidden rounded-[28px] border border-[#D8E3DE] bg-[#FDFCF8] shadow-[0_24px_60px_rgba(23,49,47,0.12)] lg:grid-cols-[0.95fr_1.05fr]">
        <div className="relative flex flex-col justify-between overflow-hidden bg-[#0B6B67] p-7 text-white sm:p-10">
          <img src="/manus-storage/clinic-route-texture_744936d1.png" alt="" className="pointer-events-none absolute inset-0 h-full w-full object-cover opacity-25 mix-blend-screen" />
          <div className="relative flex items-center gap-3"><img className="h-12 w-12 rounded-2xl" src="/manus-storage/clinic-mor-phallop-logo_bd13d3ec.png" alt="โลโก้คลินิกหมอพัลลภ" /><div><p className="font-semibold">คลินิกหมอพัลลภ</p><p className="font-mono text-[10px] font-bold tracking-[0.17em] text-[#B8DBD7]">HIS · CARE ROUTE</p></div></div>
